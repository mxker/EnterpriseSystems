...
use common\widgets\upload\FileUploadAsset;
use common\widgets\upload\FileUploadPlusAsset;
...
class FileUpload extends BaseUpload {
    ...
    public function init() {
        ...
        if ($this->buttonClass == '') {
            $this->buttonClass = 'btn btn-success fileinput-button';
        } else {
            $this->buttonClass .= ' fileinput-button';
        }
    }
    ...
    public function run() {
        ...
        ? $this->render('uploadButton', ['input' => $input, 'buttonClass' => $this->buttonClass])
        : $input;
