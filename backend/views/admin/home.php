...
<div class="profile-container">
        <div class="profile-header row">
            ...
            <div class="col-lg-5 col-md-8 col-sm-12 profile-info">
                <div class="header-fullname">edu</div>
                <a href="#" class="btn btn-palegreen btn-sm  btn-follow">
                    <i class="fa fa-check"></i>
                    已认证
                </a>
                <div class="header-information">
                    可用余额：<span style="color: red; font-size: 20px;">0</span>元<br/>
                    冻结金额：<span style="color: red">0</span>元
                </div>
            </div>
        </div>
                        ...
                        <div id="overview" class="tab-pane active">
                            <form role="form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <span class="form-group input-icon icon-right form-control">问题包裹：<a href="<?php Yii::$app->homeUrl;?>/parcel/issue">0件</a></span>
                                    </div>
                                    <div class="col-sm-6">
                                        <span class="form-group input-icon icon-right form-control">售后/工单：<a href="<?php Yii::$app->homeUrl;?>/feedback/index">0件</a></span>
                                    </div>
                                    <div class="col-sm-6">
                                        <span class="form-group input-icon icon-right form-control">在途包裹：<a href="<?php Yii::$app->homeUrl;?>/parcel/list">0件</a></span>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <form role="form">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" readonly="readonly" class="form-control" placeholder="姓名：edu">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" readonly="readonly" class="form-control" placeholder="邮箱：edu@edu.com">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" readonly="readonly" class="form-control" placeholder="手机号码：88888888">
